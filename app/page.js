  ...
  return (
    <main className="bg-white text-black">
      ...
      >
        ...
        >
          <img
            src="/foto-dafi-formal.png" // ganti foto lo
            alt="Profile"
            className="w-75 md:w-90 rounded-2xl object-cover shadow-lg"
          />
        </motion.div>
      </section>
      ...
      <section id="about" className="px-10 py-32 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="opacity-90 leading-relaxed text-sm">
            Muhammad Rayhan Khadafi merupakan siswa jurusan Pemrograman Perangkat Lunak dan Gim
            (PPLG) yang memiliki antusiasme tinggi terhadap dunia teknologi,
            terutama dalam pengembangan website dan aplikasi. Ketertarikan pada bidang
            pemrograman berawal dari rasa ingin memahami bagaimana sebuah sistem digital dirancang,
            dikembangkan, dan diimplementasikan untuk memberikan solusi yang berdampak.
          </p>

          <ul className="opacity-90 leading-relaxed mt-4 text-sm">
            Frontend Developer yang passionate dalam membangun UI modern dan interaktif.
            Fokus pada keseimbangan antara visual yang estetik dan pengalaman pengguna yang optimal.
            Senang bereksperimen dengan desain serta terus mengembangkan kemampuan untuk
            menciptakan interface yang engaging dan user-friendly.
          </ul>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {[
            ...
            },
            {
              ...
              desc: "Platform lowongan kerja sederhana untuk memudahkan pencari kerja menemukan peluang.",
              github: "https://github.com/username/berita",
              demo: "https://berita.vercel.app",
              skills: ["HTML", "Figma", "Tailwind CSS"],
            },
            {
              title: "Website Bimbingan Konseling",
              desc: "Website sistem konseling untuk membantu siswa dan guru dalam penjadwalan. ",
              github: "https://github.com/username/ecommerce",
              demo: "https://ecommerce.vercel.app",
              skills: ["TypeScript", "NextJS", "Tailwind CSS"],
            },
            {
              title: "Website Portofolio",
              desc: "Portfolio website modern dan responsif untuk menampilkan project dan skill.",
            ...
            },
            {
              ...
              desc: "Website penyewaan kamar untuk memudahkan pencari kamar.",
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-3 mt-2">
                  {project.skills?.map((tag) => (
                    <span
                      key={tag}
                      className="text-xs bg-black/10 text-black px-3 py-1 rounded-full whitespace-nowrap"
                    >
                      {tag}
                    </span>
                  ))}
           ...
           px-4 py-2 rounded-full text-sm hover:bg-gray-700 transition">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 border border-black px-6 py-2 rounded-full text-sm hover:bg-black/30 transition"
                  >
